...
import { Microscope, Pill, Activity, FileText, BriefcaseMedical, Thermometer } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-xl text-slate-600">
            We understand that behind every delivery is a patient waiting for care. Our services are designed for speed, safety, and compliance.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="mt-6 flex items-center text-brand-600 font-semibold text-sm opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">
